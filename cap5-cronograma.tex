...
\resizebox{\textwidth}{!}
{
  ...
  \ref{controlar} && \cellcolor{gray} &&&&&&&&&&  \\ \hline
  \ref{configurar}&&& \cellcolor{gray} &&&&&&&&&  \\ \hline
  \ref{descrever} &&&& \cellcolor{gray} &&&&&&&&  \\ \hline
  \ref{otimizar1} &&&&& \cellcolor{gray} &&&&&&&  \\ \hline
  \ref{otimizar2} &&&&&& \cellcolor{gray} &&&&&&  \\ \hline
  \ref{entregar}  &&&&&&& \cellcolor{gray} &&&&&  \\ \hline
  \ref{finalizar} &&&&&&&& \cellcolor{gray} &&&&  \\ \hline
  \ref{corrigir}  &&&&&&&&& \cellcolor{gray} &&&  \\ \hline
  \ref{imprimir}  &&&&&&&&&& \cellcolor{gray} &&  \\ \hline
  \ref{finalApres}&&&&&&&&&& \cellcolor{gray} &&  \\ \hline
  \ref{apresentar}&&&&&&&&&&& \cellcolor{darkgray} &  \\ \hline
  \hline
  \end{tabular}
}
\end{center}
